    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                int result;
                String string1 = (String) stock1.get("name");
                String string2 = (String) stock2.get("name");
                ...
                if ((result = string1.compareTo(string2)) != 0) {
                    return result;
                } else if ((result = date2.compareTo(date1)) != 0) {
                    return result;
                } else if ((result = change2.compareTo(change1)) != 0) {
                    return result;
                }
                return result;
            }
